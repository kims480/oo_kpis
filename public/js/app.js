...
window.Chart = chart_js__WEBPACK_IMPORTED_MODULE_5__.Chart; // window.NiceSelect=NiceSelect;
...
window.Choices = (choices_js__WEBPACK_IMPORTED_MODULE_3___default()); // window.SelectSearch = searchdrop;
