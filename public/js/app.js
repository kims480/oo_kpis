...
window.Chart = chart_js__WEBPACK_IMPORTED_MODULE_3__.Chart; // window.NiceSelect=NiceSelect;
// import { getRelativePosition } from 'chart.js/helpers';

window.Alpine = alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"];
window.swal = (sweetalert__WEBPACK_IMPORTED_MODULE_1___default());
window.Toastify = (toastify_js__WEBPACK_IMPORTED_MODULE_2___default()); // window.SelectSearch = searchdrop;
