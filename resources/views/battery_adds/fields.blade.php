...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('shelter_num', null, [
        'class' =>   $errors->has('shelter_num') ? ' is-invalid':'' ,
        'min' => 1,
        'max' => 10,
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('ref_wo', old('ref_wo'), [
        'class' =>  $errors->has('ref_wo') ? ' is-invalid': null,
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('ref_cr', old('ref_cr'), [
        'class' =>  $errors->has('ref_cr') ? ' is-invalid': null,
...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('volt_before', old('volt_before'), [
        'class' =>  $errors->has('volt_before') ? ' is-invalid': null,
...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('Amp_before', old('Amp_before'), [
        'class' =>  $errors->has('Amp_before') ? ' is-invalid': null,
...
<div
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::text('batter_1_sn', old('batter_1_sn'), [
            'class' =>  $errors->has('batter_1_sn') ? ' is-invalid': null,
        ]) !!}
        @error('batter_1_sn')
            <div class="text-red-600 text-xs">{{ $message }}</div>
        @enderror
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::text('battery_2_sn', old('battery_2_sn'), [
            'class' =>  $errors->has('battery_2_sn') ? ' is-invalid': null,
        ]) !!}
        @error('battery_2_sn')
            <div class="text-red-600 text-xs">{{ $message }}</div>
        @enderror
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::text('battery_3_sn', old('battery_3_sn'), [
            'class' =>  $errors->has('battery_3_sn') ? ' is-invalid': null,
        ]) !!}
        @error('battery_3_sn')
            <div class="text-red-600 text-xs">{{ $message }}</div>
        @enderror
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::text('battery_4_sn', old('battery_4_sn'), [
            'class' =>  $errors->has('battery_4_sn') ? ' is-invalid': null,
        ]) !!}
        @error('battery_4_sn')
            <div class="text-red-600 text-xs">{{ $message }}</div>
        @enderror
...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('num_of_rect', old('num_of_rect'), [
        'class' =>  $errors->has('num_of_rect') ? ' is-invalid': null,
        'min' => 1,
        'max' => 10,
...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('rect_num', old('rect_num'), [
        'class' =>  $errors->has('rect_num') ? ' is-invalid': null,
        'min' => 1,
        'max' => 10,
...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('bank_num', old('bank_num'), [
        'class' =>  $errors->has('bank_num') ? ' is-invalid' : null,
        'min' => 1,
        'max' => 20,
...
<div class="form-group col-sm-6">
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::number('old_batteries_aging', old('old_batteries_aging'), [
            'class' =>  $errors->has('old_batteries_aging') ? ' is-invalid': null,
            'min' => 0,
            'max' => 10,
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::number('llvd', old('llvd'), [
            'class' =>  $errors->has('llvd') ? ' is-invalid': null,
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::number('blvd', old('blvd'), [
            'class' =>  $errors->has('blvd') ? ' is-invalid': null,
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::number('capacity_rating', old('capacity_rating'), [
            'class' =>  $errors->has('capacity_rating') ? ' is-invalid': null,
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::text('battery_brand', 'SACRED SUN', [
            'class' =>  $errors->has('battery_brand') ? ' is-invalid': null,
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::text('Battery_model', 'FTA12-190A', [$errors->has('Battery_model') ? ' is-invalid': null, 'placeholder' => 'Batteries Model']) !!}
        @error('Battery_model')
            <div class="text-red-600 text-xs">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::number('Volt_after', old('Volt_after'), [
            'class' =>  $errors->has('Volt_after') ? ' is-invalid': null,
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::number('Amp_After', old('Amp_After'), [
            'class' =>  $errors->has('Amp_After') ? ' is-invalid': null,
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::text('remarks', old('remarks'), [
            'class' =>  $errors->has('remarks') ? ' is-invalid': null,
