        ...
        <div class="relative w-full flex flex-col h-screen overflow-y-hidden ">
            ...
            <header class="w-full items-center bg-white py-2 px-6 hidden sm:flex">
                ...
                <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                    ...
                    <div x-show="isOpen"
                        class="absolute z-30 flex flex-col w-32 bg-white rounded-lg shadow-lg py-2 mt-16">
                        <a href="{{ route('users.profile') }}"
                            class=" px-4 py-2 account-link hover:text-slate-800 hover:font-semibold hover:cursor-pointer">Profile</a>
                        <a href="#"
                            class=" px-4 py-2 account-link hover:text-slate-800 hover:font-semibold hover:cursor-pointer"
