...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ url('images/logo.png') }}" class="user-image img-circle elevation-2"
                            alt="User Image">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2022 <a href="http://karimsaleh.com">Karim Saleh</a>.</strong> All rights
            reserved.
        </footer>
    </div>
