<div class="card w-full p-0" x-data={filtersOn:false}>
    <div class="card-body p-0 relative w-full ">
        <div class="py-1 bg-slate-500 w-full border-b-2 border-amber-500 border-solid mb-2">
            ...
            <div class="options flex  justify-between pb-2 items-center border-b-2 border-slate-800">
                <div class="form w-2/3">
                    <form wire:submit.prevent="import">
                        ...
                        <button class="btn bg-gray-50 text-slate-900" type="submit" wire:loading.attr="disabled">Upload Sites</button>
                    </form>

                </div>

                <div class="form-check flex w-1/3 form-switch ml-auto mr-2">
                ...
                <button wire:click.prevent="export" x-data={isOpen:false}
                    class="transition text-amber-800 bg-amber-50 ease-in-out btn btn-default relative has-tooltips text-sm " data-mdb-ripple="true"
        ...
        <div class="scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-slate-300">
            ...
            <thead>
                <tr x-show="filtersOn">
                    ...
                    <th>
                        {!! Form::text('site_id', null, ['class' => 'text-sm border-0 rounded-none border-b-2 p-1 ', 'placeholder' => __('models/batteryAdds.fields.site__deployed'), 'wire:model' => 'site_id']) !!}
                    </th>
                    <th>
                        {!! Form::text('batter_1_sn', null, ['class' => 'text-sm border-0 rounded-none border-b-2 p-1 ', 'placeholder' => __('models/batteryAdds.fields.battery_sn'), 'wire:model' => 'battery_1_sn']) !!}
                    </th>
                    <th>
                        {!! Form::text('ref_wo', null, ['class' => 'text-sm border-0 rounded-none border-b-2 p-1 ', 'placeholder' => __('models/batteryAdds.fields.ref_wo'), 'wire:model' => 'ref_wo']) !!}
                    </th>
                    <th> {!! Form::text('ref_cr', null, ['class' => 'text-sm border-0 rounded-none border-b-2 p-1 ', 'placeholder' => __('models/batteryAdds.fields.ref_cr'), 'wire:model' => 'ref_cr']) !!}
                    </th>
                    <th> {!! Form::text('shelter_num', null, ['class' => 'text-sm border-0 rounded-none border-b-2 p-1 ', 'placeholder' => __('models/batteryAdds.fields.shelter_num'), 'wire:model' => 'shelter_num']) !!}
                    </th>
                    <th> {!! Form::text('num_of_rect', null, ['class' => 'text-sm border-0 rounded-none border-b-2 p-1 ', 'placeholder' => __('models/batteryAdds.fields.num_of_rect'), 'wire:model' => 'num_of_rect']) !!}
                    </th>
                    <th> {!! Form::text('rect_num', null, ['class' => 'text-sm border-0 rounded-none border-b-2 p-1 ', 'placeholder' => __('models/batteryAdds.fields.rect_num'), 'wire:model' => 'rect_num']) !!}
                    </th>
                    <th> {!! Form::text('bank_num', null, ['class' => 'text-sm border-0 rounded-none border-b-2 p-1 ', 'placeholder' => __('models/batteryAdds.fields.bank_num'), 'wire:model' => 'bank_num']) !!}
                    </th>
                    <th> {!! Form::text('added_by', null, ['class' => 'text-sm border-0 rounded-none border-b-2 p-1 ', 'placeholder' => __('models/batteryAdds.fields.added_by'), 'wire:model' => 'added_by']) !!}
                    </th>
                    <th>
