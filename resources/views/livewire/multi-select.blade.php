<div class="form-groups">
    ...
    <div x-data="select({ data: {{ $optionList }}, emptyOptionsMessage: 'No matches for your search.', name: 'site_id', placeholder: 'Select a option' })" x-init="init()" @click.away="closeListbox()" @keydown.escape="closeListbox()"
        class="relative">
        <span class="inline-block w-full rounded-md shadow-sm">
            <button x-ref="button" @click.prevent="toggleListboxVisibility()" :aria-expanded="open"
                ...
                <input x-ref="search" x-show="open" x-model="search" @keydown.enter.stop.prevent="selectOption()"
                    ...
                    type="search" class="w-full h-full " />
        ...
        <div x-show="open" x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100"
            x-transition:leave-end="opacity-0" x-cloak class="absolute z-2 0 w-full mt-1 bg-white rounded-md shadow-lg">
