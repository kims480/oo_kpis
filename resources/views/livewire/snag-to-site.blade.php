    ...
    <div class="p-2">
        ...
        <div class="p-1">
            ...
            <div class="overflow-auto lg:overflow-visible">
                ...
                <table class=" w-full table-auto mb-2 border-separate [-webkit-border-horizontal-spacing:0] [-webkit-border-vertical-spacing:15px]  space-y-6">
                    <thead>
                        <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal ">
                            <th class="py-3 px-6 text-left animate-entrance [animation-delay:0.1s]">#</th>
                            <th class="py-3 px-6 text-left w-12 overflow-hidden animate-entrance [animation-delay:0.2s]">@lang('models/siteSnags.fields.site_id')</th>
                            <th class="py-3 px-6 text-center animate-entrance [animation-delay:0.3s]">Main Categ</th>
                            <th class="py-3 px-6 text-center animate-entrance [animation-delay:0.4s]">Sub Categ</th>
                            <th class="py-3 px-6 text-center animate-entrance [animation-delay:0.5s]">@lang('models/siteSnags.fields.snagmangs')</th>
                            <th class="py-3 px-6 text-center animate-entrance [animation-delay:0.6s]">Status</th>
                            <th class="py-3 px-6 text-center animate-entrance [animation-delay:0.7s]">Reported By</th>
                            <th class="py-3 px-6 text-center animate-entrance [animation-delay:0.8s]">Domain</th>
                            <th class="py-3 px-6 text-center animate-entrance [animation-delay:0.9s]">Reported In</th>
                            <th class="py-3 px-6 text-center animate-entrance [animation-delay:1s]">Remarks</th>

                            <th class="py-3 px-6 text-center animate-entrance [animation-delay:1.1s]">@lang('crud.action')</th>
                        </tr>
                    </thead>
                    <tbody class="text-gray-600 text-sm font-light" >
                        @foreach ($SiteSnagsList as $siteSnag)
                            <tr x-data="{opacity:{{$loop->last==$loop->iteration}}}" class="border-b border-gray-200 bg-slate-50   odd:bg-gray-50 hover:bg-slate-200 animate-dropdown [animation-delay:{{$loop->iteration*0.1}}s] " :class="opacity?'opacity-100':'opacity-0'}}" >
                                <td class=" px-1 text-left whitespace-nowrap rounded-l-lg">
                                ...
                                <td class=" px-2 text-center rounded-r-lg">
